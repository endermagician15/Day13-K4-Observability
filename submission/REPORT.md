...
| Vũ Xuân Đức (2A202601668) | **Incident, Report & Demo:** Kích hoạt sự cố giả lập & challenge chính thức, đo lường liên kết Metrics -> Traces -> Logs để xác định lỗi nghẽn Event Loop. Thực hiện tối ưu hóa API (sync def chat + cache TTL) giúp giảm tải trễ ở Client và hoàn thành báo cáo REPORT.md. | [cda6980](https://github.com/endermagician15/Day13-K4-Observability/commit/cda6980) | Hiểu cơ chế nghẽn luồng Event Loop của FastAPI khi block đồng bộ bằng `time.sleep`, cách liên kết 3 trụ cột Observability để khoanh vùng và định danh lỗi nhanh chóng. |
